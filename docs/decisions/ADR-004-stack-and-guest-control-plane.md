...
**Status:** Accepted  
**Date:** 2026-07-27  
**Updated:** 2026-07-28 — ProvisioningSession as deep module; align harvest + seam discipline with ARCHITECTURE  
...
- Ticket 08 should expose one acceptance interface, not a peer forest of harness entrypoints.
