...
- Provisioning Supervisor DMA settle must restore as an ordered step under the provisioning lock (hard/soft gates: [ADR-004](ADR-004-stack-and-guest-control-plane.md)).
