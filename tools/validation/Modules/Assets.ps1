...
function Test-RequiredAssets {
    $required = @(
        ...
        'tools\release\Build-WinMintSetupShell.ps1',
        ...
        'src\runtime\firstlogon\Agent.State.ps1',
        ...
        'src\runtime\firstlogon\Agent.Load.ps1',
        'src\runtime\firstlogon\agent-module-catalog.json',
