...
# commerce, telemetry, widget, and sidebar surfaces. (Audit: decoupled from the
# privacy toggles it was previously gated on — Edge cleanup is its own concern.)

Add-WinMintRegistryTweakModule @{
    id = 'edge-policy-minimal'
    description = 'Edge Minimal cleanup (noise/privacy, commerce, widgets, image enhancement, sidebar)'
