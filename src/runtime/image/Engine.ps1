...
function New-WinMintBuildConfig {
    ...
    [pscustomobject]@{
        ...
        SetupScripts = @('SetupComplete.cmd', 'SetupComplete.ps1', 'SetupComplete\*.ps1', 'Specialize.ps1', 'DefaultUser.ps1', 'FirstLogon.ps1', 'FirstLogon.Runtime.ps1', 'WinMintAgent', 'ViVeTool')
