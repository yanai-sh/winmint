...
# Click-to-Do / export surface. Recall is the one Copilot+ AI feature treated as a blatant
...
Add-WinMintRegistryTweakModule @{
    ...
    description = 'Disable Windows Recall (snapshots, data analysis, Click-to-Do, export)'
