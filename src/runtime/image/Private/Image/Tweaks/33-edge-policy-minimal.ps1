...
# content, workspaces, Spotlight suggestions, import nags, and address-bar
# trending. Keep the Edge sidebar available because Copilot page-context chat
# is a useful explicit browser feature, not background OS bloat.

Add-WinMintRegistryTweakModule @{
    id = 'edge-policy-minimal'
    description = 'Edge Minimal cleanup (noise/privacy, commerce, widgets, image enhancement, inline compose, startup/background, new tab, workspaces, Spotlight)'
    ...
    set = @(
        ...
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'AutoImportAtFirstRun'; type = 'REG_DWORD'; value = '4'; undo = @{ action = 'delete' } },
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'GuidedSwitchEnabled'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        ...
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'NewTabPageAppLauncherEnabled'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        ...
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'EdgeWorkspacesEnabled'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        ...
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'SpotlightExperiencesAndRecommendationsEnabled'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'ImportOnEachLaunch'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'AddressBarTrendingSuggestEnabled'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'PromotionalTabsEnabled'; type = 'REG_DWORD'; value = '0'; undo = @{ action = 'delete' } },
        @{ path = 'zSOFTWARE\Policies\Microsoft\Edge'; name = 'BingAdsSuppression'; type = 'REG_DWORD'; value = '1'; undo = @{ action = 'delete' } },
