...
function Invoke-WinMintAgentLiveInstallAuditBootstrap {
    [CmdletBinding()]
    param(
    ...
    $reportPath = Join-Path $programData 'WinMint\Logs\LiveInstallAudit.json'
    $setupProfilePath = Join-Path $setupScripts 'WinMintSetupProfile.json'
