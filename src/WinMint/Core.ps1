...
function Get-WinMintPath {
    ...
    $relative = switch ($Name) {
        ...
        'Root'           { '' }
        'Apps'           { 'apps' }
        'LegacyWpfApp'   { 'apps\WinMint.LegacyWpf' }
        'LegacyWpfEntry' { 'apps\WinMint.LegacyWpf\App\Start-WinMintUI.ps1' }
        'GpuiApp'        { 'apps\WinMint.GPUI' }
        'GpuiCargoToml'  { 'apps\WinMint.GPUI\Cargo.toml' }
        'GpuiBinary'     { 'apps\WinMint.GPUI\bin\WinMint-GUI.exe' }
        'Engine'         { 'src\WinMint' }
        'EngineRoot'     { 'src\WinMint' }
        'EngineEntry'    { 'src\WinMint\WinMint.ps1' }
        'Agent'          { 'src\WinMint.Agent' }
        'AgentRoot'      { 'src\WinMint.Agent' }
        'Setup'          { 'src\WinMint.Setup' }
        'SetupRoot'      { 'src\WinMint.Setup' }
        'Assets'         { 'assets' }
        'AssetsRoot'     { 'assets' }
        'DocsRoot'       { 'docs' }
        'Config'         { 'config' }
