...
## Track E — WebView2 Wizard Completion
...
- a realistic WinMint build can be authored end-to-end through WebView2 wizard
...
Goal: make WebView2 wizard feel like the primary user-facing product.

Work:

- refine navigation, layout, component consistency, and state handling
- tighten packaged wizard assumptions and navigation polish
- keep PowerShell engine logic headless while the WebView2 shell feels complete
...
Goal: keep the CLI coherent even if WebView2 wizard becomes the default path.
...
That is why this roadmap is broader than only WebView2 wizard and VM testing, even though those remain important tracks.
