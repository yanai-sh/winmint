...
Assert-BootstrapText -Pattern 'PowerShell/PowerShell/releases/latest' -Description 'host servicing pwsh from GitHub MSI, not winget'
Assert-BootstrapText -Pattern 'win-arm64\.msi' -Description 'GitHub pwsh MSI rid for native ARM64'
Assert-BootstrapText -Pattern 'PROCESSOR_ARCHITEW6432' -Description 'host-arch detection is W6432-aware'
Assert-BootstrapTextAbsent -Pattern 'winget install --id Microsoft\.PowerShell' -Description 'host pwsh must not use winget MSIX'
