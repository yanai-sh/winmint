...
Assert-BootstrapText -Pattern '\[version\]''7\.6\.0''' -Description 'bootstrap minimum runtime pin is PowerShell 7.6.0'
Assert-BootstrapText -Pattern 'PowerShell 7\.6\.0\+ is required' -Description 'bootstrap explains the 7.6.0 runtime requirement'
...
Assert-BootstrapText -Pattern 'Installing PowerShell 7\.6\.0\+ via WinGet' -Description 'bootstrap logs the winget acquisition path for PowerShell 7.6.0'
