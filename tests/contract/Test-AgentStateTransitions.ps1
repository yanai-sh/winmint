...
try {
    ...
    function Invoke-WinMintAgentWingetUpgradeAll {
        ...
        Set-TestAgentStep -State $State -Key 'package-manager:winget-upgrade-all' -Status 'failed' -ErrorText 'upgrade warning'
    }
    ...
    Assert-Equal $script:windhawkNativeCalls 2 'Windhawk bootstrap should run restore and virtual desktop flyout scripts.'
