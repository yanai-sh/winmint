...
if (-not (Get-Command Write-WinMintUiLog -ErrorAction SilentlyContinue)) {
    . "$PSScriptRoot\Logging.ps1"
}

function Invoke-WinMintUiWithHostRunspace {
    <#
    .SYNOPSIS
...
Write-WinMintUiLog 'Loaded WPF assemblies.'
...
Write-WinMintUiLog 'ThreadJob available.'
