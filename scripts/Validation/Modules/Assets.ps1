...
function Test-RequiredAssets {
    $required = @(
        ...
        'assets\komorebi\README.md',
        'assets\fonts\CascadiaCodeNF-Regular.ttf',
        'assets\cursors\BreezeXLight\Alternate.cur',
        'assets\cursors\BreezeXLight\Arrow.cur',
        'assets\cursors\BreezeXLight\Busy.ani',
        'assets\cursors\BreezeXLight\Cross.cur',
        'assets\cursors\BreezeXLight\Grabbing.cur',
        'assets\cursors\BreezeXLight\Handwriting.cur',
        'assets\cursors\BreezeXLight\Help.cur',
        'assets\cursors\BreezeXLight\IBeam.cur',
        'assets\cursors\BreezeXLight\Link.cur',
        'assets\cursors\BreezeXLight\Move.cur',
        'assets\cursors\BreezeXLight\Pan.cur',
        'assets\cursors\BreezeXLight\Person.cur',
        'assets\cursors\BreezeXLight\Pin.cur',
        'assets\cursors\BreezeXLight\SizeNESW.cur',
        'assets\cursors\BreezeXLight\SizeNS.cur',
        'assets\cursors\BreezeXLight\SizeNWSE.cur',
        'assets\cursors\BreezeXLight\SizeWE.cur',
        'assets\cursors\BreezeXLight\Unavailable.cur',
        'assets\cursors\BreezeXLight\Work.ani',
        'assets\cursors\BreezeXLight\ZoomIn.cur',
        'assets\cursors\BreezeXLight\ZoomOut.cur',
        ...
        'scripts\release\New-WinMintReleaseBundle.ps1',
        'scripts\audit\Audit-LiveInstall.ps1',
        'scripts\setup\WindhawkBootstrap.ps1',
        'scripts\setup\WindhawkBootstrap.Helpers.ps1',
        'src\WinWS\Private\Pipeline.Console.ps1',
        'src\WinWS.UI\Foundation\FileSystemLiterals.ps1',
        'src\WinWS.UI\Foundation\UiSession.ps1',
        'src\WinWS.UI\Services\Theme.ps1',
        'src\WinWS.UI\Services\UiFramework.ps1',
        'src\WinWS.UI\Services\UiInteraction.ps1',
        ...
        'src\WinWS.Agent\Agent.Console.ps1',
        'src\WinWS.Agent\Agent.Runtime.ps1',
        'src\WinWS.Agent\Start-WinWSAgent.ps1',
        'src\WinWS.Agent\Start-WinWSFirstLogonUI.ps1',
        'src\WinWS.Agent\Start-WinWSFirstLogonUI.xaml',
        'src\WinWS.Agent\BuildProfile.json',
        'src\WinWS.Agent\Modules\PackageManagers.ps1',
        'src\WinWS.Agent\Modules\Editors.ps1',
        'src\WinWS.Agent\Modules\Git.ps1',
        'src\WinWS.Agent\Modules\Dotfiles.ps1',
        'src\WinWS.Agent\Modules\Wsl.ps1',
        'src\WinWS.Agent\Modules\FlowEverything.ps1',
        'src\WinWS.Agent\Modules\LiveInstallAudit.ps1',
        'src\WinWS.Agent\Modules\TilingDesktop.ps1',
        'src\WinWS.Agent\Modules\Windhawk.ps1',
        'src\WinWS.Agent\Modules\Profiles.ps1',
        'src\WinWS.UI\Profiles\README.md'
    )
...
function Test-WindhawkPresetPayload {
    ...
    try {
        ...
        if ($preset.schema -ne 'winws.windhawkPreset.v1') {
